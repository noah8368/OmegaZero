...
Output:
    data  — a fresh unc_research/models/<datetime>/figs/ run dir.
...
Usage:
    ...
    python3 unc_research/scripts/generate_unc_plots.py model unc_research/models/<run>
"""
...
def main():
    ...
    m.add_argument("run", help="a run dir under unc_research/models/ "
