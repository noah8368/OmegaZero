...
See unc_research/experiments/unc-001.md for the design and unc_research/hypotheses.md for H0/H2.

Usage:
    python unc_research/scripts/unc001_synthetic.py \
        --generator hetero_gaussian lognormal bimodal skewnormal \
        --model flow qr mdn unconditional \
        --n 20000 --epochs 150 --seed 0 \
        --outdir unc_research/experiment_results/unc-001
...
def main():
    ...
    p.add_argument("--outdir", default="unc_research/experiment_results/unc-001")
    run(p.parse_args())
