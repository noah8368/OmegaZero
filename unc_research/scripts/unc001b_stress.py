...
See unc_research/experiments/unc-001b.md for the design and unc_research/hypotheses.md (H2/H3/H5).

Usage:
    # Phase 1 (fair comparison), full rigor:
    python unc_research/scripts/unc001b_stress.py --phase 1 --seeds 10 --capacity med \
        --outdir unc_research/experiment_results/unc-001b
    # Capacity frontier instead of a single preset:
    python unc_research/scripts/unc001b_stress.py --phase 1 --capacity sweep
    # Phase 2 (crossover sweep) — only if Phase 1 is close:
    python unc_research/scripts/unc001b_stress.py --phase 2 --seeds 5
"""
...
def main():
    ...
    p.add_argument("--outdir", default="unc_research/experiment_results/unc-001b")
    args = p.parse_args()
